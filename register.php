...
$customer_contact = $_POST['customer_contact'];
  ...
  $Result1 = mysqli_query($db, "INSERT INTO customers (customer_name, customer_email, customer_pass, customer_contact) VALUES ('$customer_name' , '$customer_email', '$pass','$customer_contact')");
...
mysqli_select_db($db,"ecommerce");
$Register = mysqli_query($db, "SELECT customer_name, customer_email, customer_pass, customer_contact FROM customers") ;
?>
<!DOCTYPE html>
<?php ?>
<html>
<head>
<title>CLICK WHEN HUNGRY/Register</title>
<!-- for-mobile-apps -->
