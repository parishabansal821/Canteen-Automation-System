...
$products = mysqli_query($db, $query_products) or die(mysqli_error());
$product = mysqli_query($db, $query_product) or die(mysqli_error());
$produc = mysqli_query($db, $query_produc) or die(mysqli_error());
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class="active "><a class="hyper "><span>Hi <?php echo $_SESSION['customer_email'];?> </span></a></li>	
						</ul>
					</div>
					</nav>
					 <div class="cart" >
...
<!--content-->
				...
				<div class="modal-dialog" role="document">
					...
					<div class="tab-pane  text-style" id="tab2">
						<div class=" con-w3l">
						<?php while($row_produc = mysqli_fetch_assoc($produc)){ ?>
  ...
  $(function () {
    ...
    $('.my-cart-btn').myCart({
      ...
      checkoutCart: function(products, totalPrice, totalQuantity) {
       ...
       window.location.replace("http://localhost/CMS1/wishlist.php");
